module.express = {
    register: async (req, res) => {
        ...
        // check if an existing user matches the email trying to be registerd with, if so , reject
        try {
    ...
    login: (req, res) => {
        ...
        // compare the password from req.body with the stored hash that we just retrieved ..if you mismatch, reject
